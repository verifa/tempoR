...
delta <- max(user.summary$hours) - target
...
accumulated <- ggplot(data = user.summary) +
  ...
  annotate("text", 
           ...
           color = "Dark Blue") +
  geom_point(aes(x = date, y = hours), color = "Dark Blue") +
  geom_smooth(aes(x = date, y = hours), color = "Dark Blue") +
  geom_point(aes(x = date, y = billable), color = "Dark Green") +
  geom_smooth(aes(x = date, y = billable), color = "Dark Green") +
