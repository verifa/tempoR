...
accumulated <- ggplot(data = user.summary) +
  ...
  annotate("text", 
           ...
           color = "Dark Blue") +
  geom_point(aes(x = date, y = cumulative.hours), color = "Dark Blue") +
  geom_smooth(aes(x = date, y = cumulative.hours), color = "Dark Blue") +
  geom_point(aes(x = date, y = cumulative.billable), color = "Dark Green") +
  geom_smooth(aes(x = date, y = cumulative.billable), color = "Dark Green") +
