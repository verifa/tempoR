...
tempo <- ggplot(data = user.data) +
  ...
  geom_point(data = user.summary, aes(x = date, y = roll.7.hours/5), color = "Gray15") + 
  geom_point(data = user.summary, aes(x = date, y = roll.7.billable/5), color = "Gray35") + 
...
rolling <- ggplot(data = user.summary) +
  geom_point(aes(x = date, y = roll.7.hours), color = "Gray50") + 
  geom_point(aes(x = date, y = roll.7.billable), color = "Gray75") + 
...
accumulated <- ggplot(data = user.delta) +
  ...
  scale_y_continuous(name = "Delta hours [h]")
```
